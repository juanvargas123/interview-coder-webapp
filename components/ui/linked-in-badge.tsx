  ...
  return (
    <div className="lg:pt-0 pt-24">
      <Link
        ...
        target="_blank"
        className="hover:opacity-90 transition-opacity items-center flex gap-4 px-8 py-2 rounded-xl bg-[#FFD700]/10 text-[#FFD700] mb-12 border border-[#FFD700]/40 shadow-[0_0_15px_rgba(255,215,0,0.3)] w-fit mx-auto"
      >
        <div>
          <Image
            alt="Linkedin Badge"
